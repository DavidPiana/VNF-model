...
def build(num_demands: int | None, start_demand: int = 0, aif_nodes: list[str] = []):
    # Leggi topologia
    inside = (DATA_DIR / "inside_topology_ta1").read_text()
    ...
    # Leggi delay
    delay_data = parse_param_matrix((DATA_DIR / "delay_ta1.dat").read_text(), "delay_link")
    ...
    sndlib_text = (DATA_DIR / "SNDLIB_ta1").read_text()
